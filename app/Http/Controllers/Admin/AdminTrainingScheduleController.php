...
class AdminTrainingScheduleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.training-schedules.create', compact('courses', 'trainers'));
    }
    ...
    public function edit(TrainingSchedule $trainingSchedule)
    {
        ...
        return view('admin.training-schedules.edit', compact('trainingSchedule', 'courses', 'trainers'));
    }
