    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:#003087;">
                <i class="fas fa-pen mr-2" style="color:#CE1126;"></i> Edit Enrollment
            </h1>
            <p class="text-sm mt-0.5" style="color:#5a7aaa;">Updating enrollment for {{ $enrollment->trainee->name }}</p>
        </div>
    </div>
