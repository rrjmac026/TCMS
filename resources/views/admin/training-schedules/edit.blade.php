    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:#003087;">
                <i class="fas fa-pen mr-2" style="color:#CE1126;"></i> Edit Training Schedule
            </h1>
            <p class="text-sm mt-0.5" style="color:#5a7aaa;">Updating schedule for {{ $trainingSchedule->course->name }}</p>
        </div>
    </div>
