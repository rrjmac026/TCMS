...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:var(--usf-accent);">
                <i class="fas fa-pen mr-2" style="color:var(--usf-red);"></i> Edit User
            </h1>
            <p class="text-sm mt-0.5" style="color:var(--usf-text-sec);">Updating details for {{ $user->name }}</p>
        </div>
    </div>
    ...
    <div class="rounded-2xl border overflow-hidden dark:bg-[#0d1f3c] dark:border-[#1e3a6b]"
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-8 space-y-6">
            ...
            <div>
                <label class="block text-xs font-700 uppercase tracking-wide mb-1.5" style="color:var(--usf-text-sec);">
                    New Password <span class="font-400 normal-case" style="color:var(--usf-text-sec);">(leave blank to keep current)</span>
                </label>
