    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:#003087;">
                <i class="fas fa-plus mr-2" style="color:#CE1126;"></i> Record Attendance
            </h1>
            <p class="text-sm mt-0.5" style="color:#5a7aaa;">Add a new attendance record</p>
        </div>
    </div>
                    ...
                    @foreach (['present' => ['label' => 'Present', 'icon' => 'fa-check-circle', 'color' => '#22C55E', 'bg' => 'rgba(34,197,94,0.10)'],
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 rounded-xl border-2 transition text-center"
                                 style="border-color:{{ old('status') === $key ? $option['color'] : '#c5d8f5' }}; background:{{ old('status') === $key ? $option['bg'] : '#fff' }};">
