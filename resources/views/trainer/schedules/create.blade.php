...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:var(--sch-accent);">
                <i class="fas fa-plus mr-2" style="color:var(--sch-red);"></i> Add Training Schedule
            </h1>
            <p class="text-sm mt-0.5" style="color:var(--sch-text-sec);">Create a new training schedule</p>
        </div>
    </div>
    ...
    <div class="rounded-2xl border overflow-hidden dark:bg-[#0d1f3c] dark:border-[#1e3a6b]"
        ...
        <form method="POST" action="{{ route('trainer.schedules.store') }}" class="p-8 space-y-6">
            @csrf
