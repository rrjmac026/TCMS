...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm mt-1" style="color:var(--en-text-sec);">
                View all your course enrollments and progress.
            </p>
        </div>
    ...
    <div class="rounded-2xl border p-5 dark:bg-[#0d1f3c] dark:border-[#1e3a6b]"
        ...
        <form method="GET" action="{{ route('trainee.enrollments.index') }}"
            ...
            <div class="relative flex-1">
                ...
                <input type="text" name="search" value="{{ request('search') }}"
                       ...
                       onblur="this.style.borderColor='var(--en-border)'; this.style.boxShadow='none'">
            </div>
            <select name="status"
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr style="background:var(--en-accent-bg); border-bottom:1px solid var(--en-border);">
                        ...
                        <th class="px-5 py-3 text-center font-700 text-xs uppercase tracking-wide" style="color:var(--en-accent);">Action</th>
                    </tr>
                </thead>
                    ...
                    @forelse ($enrollments as $enrollment)
                        <tr class="transition hover:bg-[#f0f5ff] dark:hover:bg-[#122550]">
                            ...
                            <td class="px-5 py-4 text-center">
                                @php
                                    $statusColors = [
                                        'pending' => ['bg' => 'rgba(234,179,8,0.15)', 'color' => '#eab308', 'icon' => 'fa-hourglass-half'],
                            ...
                            <td class="px-5 py-4 text-center">
                                <a href="{{ route('trainee.enrollments.show', $enrollment) }}"
                                   class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-xs transition hover:scale-110"
                        ...
                        <tr>
                            <td colspan="5" class="px-5 py-16 text-center">
                                <div class="flex flex-col items-center gap-3" style="color:var(--en-text-sec);">
                                    ...
                                    <p class="font-600">No enrollments yet</p>
                                    <p class="text-xs">Browse courses and submit your enrollment requests.</p>
                                    <a href="{{ route('trainee.courses.index') }}"
                                       class="mt-2 inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-600 text-white"
                                       style="background:linear-gradient(135deg,var(--en-accent),#003087);">
