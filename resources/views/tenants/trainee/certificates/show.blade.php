...
<div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        <div class="text-xs font-700 uppercase tracking-wide mb-0.5" style="color:var(--certd-muted);">Issued By</div>
                        <div class="text-sm font-600" style="color:var(--certd-text);">
                            {{ $certificate->trainer->name }}
                        </div>
                        <div class="text-xs mt-1" style="color:var(--certd-muted);">
                            {{ $certificate->trainer->email }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <div class="text-xs font-700 uppercase tracking-wide mb-1" style="color:var(--certd-muted);">Issued</div>
                    <div class="text-sm font-600" style="color:var(--certd-text);">
                        {{ $certificate->issued_at->format('F d, Y') }}
                    </div>
                ...
                <div>
                    <div class="text-xs font-700 uppercase tracking-wide mb-1" style="color:var(--certd-muted);">Last Updated</div>
                    <div class="text-sm font-600" style="color:var(--certd-text);">
    ...
    <div class="flex flex-col sm:flex-row flex-wrap gap-3">
        <a href="{{ route('trainee.certificates.preview', $certificate) }}"
