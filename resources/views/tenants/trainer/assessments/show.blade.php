...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm mt-0.5" style="color:var(--asf-text-sec);">View assessment information</p>
        </div>
    </div>
        ...
        <div class="p-8 space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="font-700 text-lg" style="color:var(--asf-text);">{{ $assessment->enrollment->trainee->name }}</div>
                    <p class="text-sm mt-1" style="color:var(--asf-text-sec);">{{ $assessment->enrollment->trainee->email }}</p>
                </div>
    ...
    <div class="rounded-2xl border overflow-hidden"
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4 pt-4" style="border-top:1px solid var(--asf-border);">
                ...
                <div>
                    <p class="text-xs font-600" style="color:var(--asf-text-sec);">Created</p>
