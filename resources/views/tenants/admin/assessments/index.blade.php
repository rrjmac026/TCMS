    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm mt-1" style="color:var(--asf-text-sec);">
                Record and manage all trainee assessments
            </p>
        </div>
        ...
        <form method="GET" action="{{ route('admin.assessments.index') }}"
            ...
            <div class="relative flex-1">
                ...
                <input type="text" name="search" value="{{ request('search') }}"
                       placeholder="Search by trainee, course, or trainer..."
            ...
            <select name="result"
                    ...
                    style="border-color:var(--asf-border); color:var(--asf-text);"
                    onfocus="this.style.borderColor='var(--asf-accent)'"
                    onblur="this.style.borderColor='var(--asf-border)'">
            ...
            @if(request()->hasAny(['search', 'result', 'trainer_id']))
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y" style="border-color:var(--asf-border);">
                    @forelse ($assessments as $assessment)
                        <tr class="transition hover:bg-opacity-50" style="background:var(--asf-surface);">
                            ...
                            <td class="px-5 py-3 text-sm font-600" style="color:var(--asf-text-sec);">
                                ...
                                <div class="text-xs font-400">{{ $assessment->enrollment->course->code ?? '' }}</div>
                            </td>
                            <td class="px-5 py-3 text-sm font-600" style="color:var(--asf-text-sec);">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-5 py-10 text-center text-sm" style="color:var(--asf-text-sec);">
