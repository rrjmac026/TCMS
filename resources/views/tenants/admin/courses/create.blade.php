    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold dark:text-white" style="color:var(--crsf-accent);">
                <i class="fas fa-plus mr-2" style="color:var(--crsf-red);"></i> Add Course
            </h1>
            <p class="text-sm mt-0.5" style="color:var(--crsf-text-sec);">Create a new training course</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.courses.store') }}" class="p-8 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          ...
                          onfocus="this.style.borderColor='var(--crsf-accent)'; this.style.boxShadow='0 0 0 3px rgba(0,87,184,0.10)'"
                          onblur="this.style.borderColor='{{ $errors->has('description') ? 'var(--crsf-red)' : 'var(--crsf-border)' }}'; this.style.boxShadow='none'">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-xs mt-1" style="color:var(--crsf-red);">{{ $message }}</p>
                @enderror
            </div>
